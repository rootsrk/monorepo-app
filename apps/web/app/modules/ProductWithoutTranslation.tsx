...
export function ProductWithoutTranslation() {
          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            ...
            <div className="mt-8 lg:col-span-5">
              <form>
                {/* Color picker */}
                <div>
                  <h2 className="text-sm font-medium text-gray-9">Color</h2>
                ...
                <div className="mt-8">
                  <div className="flex items-center justify-between">
                    <h2 className="text-sm font-medium text-gray-9">Size</h2>
                    <a
                      href="/sizing"
                      className="text-sm font-medium text-primary-6 hover:text-primary-5"
                    >
              ...
              {/* Product details */}
              <div className="mt-10">
                <h2 className="text-sm font-medium text-gray-9">Description</h2>
